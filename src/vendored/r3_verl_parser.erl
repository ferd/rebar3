-module(r3_verl_parser).

-export([parse_requirement/1, parse_version/1, parse_version/2]).

-type operator() :: '!=' | '&&' | '<' | '<=' | '==' | '>' | '>=' | '||' | '~>' | bitstring().

-spec parse_version(r3_verl:version()) ->
    {ok, {r3_verl:major(), r3_verl:minor(), r3_verl:patch(), [r3_verl:pre()], [r3_verl:build()]}} |
    {error, invalid_version}.
parse_version(Str) -> parse_version(Str, false).

-spec parse_version(r3_verl:version(), boolean()) ->
    {ok, {r3_verl:major(), r3_verl:minor(), r3_verl:patch(), [r3_verl:pre()], [r3_verl:build()]}} |
    {error, invalid_version}.
...
-spec parse_requirement(r3_verl:requirement()) ->
...
-spec parse_and_convert(r3_verl:version(), boolean()) ->
    {error, invalid_version} |
    {ok,
        {integer(), integer(),
            'undefined' |
